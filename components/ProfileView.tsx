            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(280px,340px)_1fr] lg:gap-10">
              <div className="space-y-6">
                <div className="card-premium p-10 flex flex-col items-center">
                  ...
                  <p className="text-[10px] font-black text-apple-muted opacity-60 uppercase tracking-[0.2em] mb-6">
                    {user?.role || "Agent Municipal"}
                  </p>
                ...
                <button
                  onClick={logout}
                  className="w-full flex items-center justify-center gap-3 py-5 rounded-[28px] bg-red-500/10 text-red-500 font-black text-sm hover:bg-red-500 hover:text-white transition-all border border-red-500/20 shadow-lg shadow-red-500/10 group"
                >
              ...
              <div className="min-w-0 space-y-8">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={clsx(
                        ...
                        i !== arr.length - 1 &&
                          "border-b border-[var(--card-border)] mb-1",
                      )}
                    >
                      <div className="flex items-center gap-5">
                        <div
                          className={`w-14 h-14 rounded-[22px] ${item.bg} ${item.color} flex items-center justify-center transition-all group-hover:scale-110 shadow-sm border border-white/20`}
                        >
                          <item.icon className="w-7 h-7" />
                        </div>
                        <span className="font-black text-[var(--foreground)] text-lg tracking-tight">
                          {item.label}
                        </span>
                      </div>
                ...
                <div className="bg-[var(--accent)] rounded-[38px] p-10 text-white relative overflow-hidden shadow-2xl shadow-[var(--accent)]/30">
                  <div className="relative z-10">
                    ...
                    <p className="text-white/70 text-sm mb-8 leading-relaxed font-medium max-w-sm">
                      Consultez notre base de connaissance ou contactez notre
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
            ...
            <div className="card-premium p-12 space-y-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                  <label className="block text-[10px] font-black text-apple-muted uppercase tracking-[0.2em] mb-4 opacity-60">
                    PRÉNOM
                  </label>
                  <input
                    type="text"
              ...
              <div className="p-8 bg-blue-500/10 rounded-[32px] border border-blue-500/20 flex gap-5">
                ...
                <div>
                  <p className="text-sm text-[var(--foreground)] leading-relaxed font-medium">
                    Votre <strong>CityID</strong> est lié à votre collectivité
                    territoriale. Seul un administrateur système peut modifier
          ...
          <div className="animate-in fade-in slide-in-from-right-8 duration-500">
            ...
            <div className="card-premium mx-auto max-w-2xl space-y-10 p-12">
              <div className="space-y-8">
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute right-7 top-[52px] text-zinc-400 hover:text-[var(--accent)] transition-colors"
                  >
                    {showPass ? (
              ...
              <div className="p-8 bg-amber-500/10 rounded-[32px] border border-amber-500/20 flex gap-5">
                ...
                <div>
                  <p className="font-black text-amber-500 text-xs mb-2 uppercase tracking-widest">
                    Conseil de sécurité
                  </p>
                  <p className="text-[11px] text-[var(--muted)] font-medium leading-relaxed">
                    Utilisez au moins 8 caractères, incluant des majuscules, des
            ...
            <div className="card-premium overflow-hidden p-2">
              {[
                ...
                },
                {
                  ...
                  desc: "Notifications lors de nouvelles suggestions d'idées.",
                  active: false,
                },
                {
                ...
                <div
                  key={i}
                  className={clsx(
                    "flex items-center justify-between p-8 rounded-[32px] hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-all",
                    i !== arr.length - 1 &&
                      "border-b border-[var(--card-border)] mb-1",
                  )}
                >
                  <div className="max-w-md">
                    <h4 className="font-black text-[var(--foreground)] text-lg mb-1 tracking-tight">
                      {item.title}
                    </h4>
                    <p className="text-sm text-[var(--muted)] font-medium leading-relaxed opacity-70">
                      {item.desc}
                    </p>
                  </div>
                  <button
                    className={clsx(
                      "w-16 h-9 rounded-full relative transition-all duration-500 shadow-inner",
                      item.active
                        ? "bg-[var(--accent)]"
                  ...
                  >
                    <div
                      className={clsx(
                        "absolute top-1 w-7 h-7 bg-white rounded-full shadow-lg transition-all duration-500 transform",
              ...
              {[
                {
                  ...
                  icon: Shield,
                  desc: "Maîtrisez la console de modération IA.",
                  color: "text-blue-500",
                  bg: "bg-blue-500/10",
                },
                {
                  ...
                  icon: Smartphone,
                  desc: "Personnalisez votre application mobile.",
                  color: "text-emerald-500",
                  bg: "bg-emerald-500/10",
                },
                {
                  title: "Analyse Municip'All Pulse",
                  icon: Loader2,
                  desc: "Comprendre les indicateurs de satisfaction.",
                  color: "text-purple-500",
                  bg: "bg-purple-500/10",
                },
                {
                  ...
                  icon: Mail,
                  desc: "Support technique disponible 24/7.",
                  color: "text-amber-500",
                  bg: "bg-amber-500/10",
                },
              ].map((item, i) => (
                <button
                  key={i}
                  className="card-premium p-10 text-left hover:scale-[1.02] transition-all group flex flex-col items-start h-full"
                >
                  <div
                    className={`w-16 h-16 rounded-[24px] ${item.bg} ${item.color} flex items-center justify-center mb-8 group-hover:scale-110 transition-all border border-white/20 shadow-sm`}
                  >
                    <item.icon className="w-8 h-8" />
                  </div>
                  <h4 className="font-black text-[var(--foreground)] mb-3 text-xl tracking-tight">
                    {item.title}
                  </h4>
                  <p className="text-sm text-[var(--muted)] font-medium leading-relaxed mb-10 flex-1">
                    {item.desc}
                  </p>
                  <span className="text-[var(--accent)] font-black text-xs uppercase tracking-widest flex items-center gap-2 group-hover:gap-3 transition-all">
